	...
	if (isset($received_count)) {
		echo '<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table class="table">
					<tr><td><h3>'.lang("BALANCE_BALANCE").'</h3></td><td width="75%"><h3><span class="label label-success">'.TrimTrailingZeroes(number_format($balance,8)).' NK</span></h3></td></tr>
					<tr><td>'.lang("SENT_SENT").'</td><td><span class="label label-danger">'.TrimTrailingZeroes(number_format($sent_count,0)).' '.lang("INPUTS_INPUTS").' / '.TrimTrailingZeroes(number_format($sent_total,8)).' NK</span></td></tr>
					<tr><td>'.lang("RECEIVED_RECEIVED").'</td><td><span class="label label-success">'.TrimTrailingZeroes(number_format($received_count,0)).' '.lang("OUTPUTS_OUTPUTS").' / '.TrimTrailingZeroes(number_format($received_total,8)).' NK</span></td></tr>
					</table>
				</div>
				</div>';
		...
		echo '<div class="panel panel-default">
				...
				<thead>
				<tr><th>'.lang("TX_ID").'</th><th>'.lang("TYPE_TYPE").'</th><th>'.lang("DATE_DATE").'</th><th>'.lang("VALUE_VALUE").' [NK]</th><th>'.lang("BALANCE_BALANCE").' [NK]</th></tr>
				</thead>
				<tbody>';
		...
		echo '<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<table class="table">
					<tr><td><h3>'.lang("BALANCE_BALANCE").'</h3></td><td width="75%"><h3><span class="label label-success">0 NK</span></h3></td></tr>
					<tr><td>'.lang("SENT_SENT").'</td><td><span class="label label-danger">0 '.lang("INPUTS_INPUTS").' / 0 NK</span></td></tr>
					<tr><td>'.lang("RECEIVED_RECEIVED").'</td><td><span class="label label-success">0 '.lang("OUTPUTS_OUTPUTS").' / 0 NK</span></td></tr>
					</table>
				</div>
				</div>';
