	...
	<div class="panel panel-default">
		...
		<script>
			...
			<?php
				...
				echo '<tr><td>'.lang('COINS_AVAILABLE').'</td><td>'.TrimTrailingZeroes(number_format($total_coins,2)).' NK</td><td><span class="label label-'.$mint_color.'">'.TrimTrailingZeroes(number_format($mint_estimate,2)).' NK</span> <span class="label label-'.$mint_color.'">'.lang('ANNUAL_GROWTH').': '.TrimTrailingZeroes(number_format($annual_inflation,2)).' %</span></td></tr>';
	...
	<div class="panel panel-default">
		...
		<div class="panel-body collapse" id="24hStatistics">
			...
			<?php
				...
				echo '<tr><td>'.lang('NK_MINTED').'</td><td>'.TrimTrailingZeroes(number_format($minted,8)).' NK</td></tr>';
				...
				echo '<tr><td>'.lang('TOTAL_FEES').'</td><td>'.TrimTrailingZeroes(number_format($fees,8)).' NK</td></tr>';
				echo '<tr><td>'.lang('TOTAL_OUTPUT').'</td><td>'.TrimTrailingZeroes(number_format($tx_out,8)).' NK</td></tr>';
	...
	<div class="panel panel-default">
		...
		<div class="panel-body collapse" id="24hTXStatistics">
			...
			<?php
				...
				echo '<tr><td>'.lang('TOTAL_FEES').'</td><td>'.TrimTrailingZeroes(number_format($wo_fees,7)).' NK</td></tr>';
				echo '<tr><td>'.lang('TOTAL_OUTPUT').'</td><td>'.TrimTrailingZeroes(number_format($wo_tx_out,8)).' NK</td></tr>';
