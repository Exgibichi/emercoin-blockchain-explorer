...
if (isset($_GET['address'])) {
	...
	echo '<table class="table">
			<tr><th>'.lang("RECEIVED_TX").'</th><th>'.lang("COINS_COINS").'</th><th>'.lang("AGE_AGE").' ['.lang("DAYS_DAYS").']</th><th>'.lang("AVG_AGE").' [<small><sup>'.lang("DAYS_DAYS").'</sup>/<sub>'.lang("COIN_COIN").'</sub></small>]</th><th>'.lang("MINTING_CHANCE").' <small><sub>'.lang("WITHIN_H").'</sub></small> [%]</th><th>'.lang("ESTIMATED_REWARD").' [NK]</th>';
