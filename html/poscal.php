...
<div class="container">
	<h2>Proof-of-Stake</h2>
	  ...
	  <div class="row">
		...
		<div class="col-sm-8">
	    	<table class="table">
						<tr><th colspan="2"><?php echo lang("MINTING_CHANCE");?></th><th><?php echo lang("ESTIMATED_REWARD");?> [NK]</th><tr>
	  ...
	  <hr>
		<h2>Proof-of-Work - Merged Mining - NK/BTC </h2>
		<div class="row">
	    <div class="col-sm-offset-2 col-sm-8">
	  ...
	  <div class="row">
	    <div class="col-sm-offset-2 col-sm-8">
	      NK PoW Difficulty <input type="input" class="form-control" id="inputPoWDiff" placeholder="NK PoW-Difficulty" value="<?php echo $powDifficulty; ?>">
	    </div>
	  </div>
	  <div class="row">
	    <div class="col-sm-offset-2 col-sm-8">
	  ...
	  <div class="row">
		...
		<div class="col-sm-8">
	    	<table class="table">
					<tr><th>Avg. time to find a NK block</th><th>Est. reward per day [NK]</th><th>PoW Block Reward [NK]</th><tr>
