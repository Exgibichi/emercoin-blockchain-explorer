	...
	if (isset($blockid)) {
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="table">
					...
					<tr><td>'.lang("INPUTS_INPUTS").'</td><td><span class="label label-danger">'.TrimTrailingZeroes(number_format($numvin,0)).' / '.TrimTrailingZeroes(number_format($valuein,8)).' NK</span></td></tr>
					<tr><td>'.lang("OUTPUTS_OUTPUTS").'</td><td><span class="label label-success">'.TrimTrailingZeroes(number_format($numvout,0)).' / '.TrimTrailingZeroes(number_format($valueout,8)).' NK</span></td></tr>';
					if ($fee<0) {
						echo '<tr><td>'.lang("MINT_MINT").'</td><td>'.($fee*(-1)).' NK</td></tr>';
					} else {
						echo '<tr><td>'.lang("FEE_FEE").'</td><td>'.$fee.' NK</td></tr>';
					}
					echo '<tr><td>'.lang("COIN_DESTROYED").'</td><td>'.TrimTrailingZeroes(number_format($coindaysdestroyed,8)).' '.lang("COIN_COIN").'*'.lang("DAYS_DAYS").' / '.$valuein.' NK = '.TrimTrailingZeroes(number_format($avgcoindaysdestroyed,8)).' '.lang("DAYS_DAYS").'</sub></td></tr>
				</table>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="table">
					<tr><th>'.lang("RECEIVED_TX").'</th><th>'.lang("TRACE_TRACE").'</th><th>'.lang("VALUE_VALUE").' [NK]</th><th>'.lang("ADDRESS_ADDRESS").'</th><th>'.lang("COIN_DAYS").' ['.lang("DAYS_DAYS").']</th></tr>';
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="table">
					<tr><th>'.lang("SPEND_TX").'</th><th>'.lang("TRACE_TRACE").'</th><th>'.lang("VALUE_VALUE").' [NK]</th><th>'.lang("ADDRESS_ADDRESS").'</th></tr>';
