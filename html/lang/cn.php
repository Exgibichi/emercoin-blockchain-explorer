...
function lang($phrase){
 ...
 'CHAIN_COIN' => '块链币龄销毁 [天/币]',
                ...
                'VALUE_NK' => '转出总量 [NK]',
                'WELCOME_EXPLORER' => '欢迎来到崛起币(Neko)区块浏览器',
                ...
                'THIS_BALANCE2' => '崛起币（NK）。',
                'TRANSACTION_NK' => '交易费:',
                'USERNAME_USERNAME' => '用户名',
                'VALID_EXTERNAL' => '有效 (站外)',
                'VALID_INTERNAL' => '有效 (站内)',
                'VOLUME_VOLUME' => '交易总量',
                'NKSSL_VERYHIGH' => '同时使用当前密码和NKSSL登陆 [超级安全]',
                'NKSSL_HIGH' => '使用NKSSL [高安全]',
                'NKSSL_LOW' => '使用NKSSL或密码 [低安全]',
                'NKSSL_DEACTIVATE' => '解除NKSSL证书登陆绑定',
                'YOUR_CERTIFICATE' => '您的NKSSL证书',
                'YOU_LOGIN' => '您可以使用NKSSL来保证您的登陆安全。',
                'WHAT_NKSSL' => '什么是NKSSL?',
                'NKSSL_SET' => 'NKSSL设置已保存',
                ...
                'STOCK_BTC' => '市场价 - NK/BTC', 
                'STOCK_USD' => '市场价 - NK/USD', 
                'STAKE_PERIOD' => '本时段利息',
                'EARNED_STAKE' => '利息收入',
                'AVERAGE_AT' => '均价',
                'VWAP_VWAP' => '成交量加权均价',
                ...
                'SEND_COINS' => '发送NK',
                'THIS_SUBSTRACTBALANCE' => '该笔交易将从您的余额中消耗"+ (parseFloat(amount)+parseFloat(fee)) +"NK。',
                'THIS_SUBSTRACTBALANCE2' => '该笔交易将从您的余额中消耗 "+amount+" NK。',
...
币将发送至该新地址，该地址不会在您的账户内创建，您稍后可将该注册地址更改至您自己所拥有的某一确定地址或其他地址。',
                ...
                'MAINTENANCE_MAINTENANCE' => 'Neko 区块浏览器正在维护，请稍后！',
