...
function lang($phrase){
    static $lang = array(
		...
		'VALUE_NK' => 'Value [NK]',
		'WELCOME_EXPLORER' => 'Welcome to the Neko Blockchain Explorer',
		...
		'BALANCE_NK' => 'Balance [NK]',
		'HOLDINGS_NK' => 'Holdings [NK]',
		...
		'TRANSACTION_NK' => 'Transaction fee:',
		'USERNAME_USERNAME' => 'Username',
		'VALID_EXTERNAL' => 'valid (external)',
		'VALID_INTERNAL' => 'valid (internal)',
		'VOLUME_VOLUME' => 'Volume',
		'NKSSL_VERYHIGH' => 'Use NKSSL with current password [Very High Security]',
		'NKSSL_HIGH' => 'Use NKSSL only [High Security]',
		'NKSSL_LOW' => 'Use NKSSL or password [Low Security]',
		'NKSSL_DEACTIVATE' => 'Deactivate NKSSL',
		'YOUR_CERTIFICATE' => 'Your NKSSL certificate',
		'YOU_LOGIN' => 'You can use NKSSL to secure your login.',
		'WHAT_NKSSL' => 'What is NKSSL?',
		'NKSSL_SET' => 'NKSSL settings saved',
		...
		'STOCK_BTC' => 'Stock Ex. - NK/BTC',
		'STOCK_USD' => 'Stock Ex. - NK/USD',
		...
		'THIS_SUBSTRACTBALANCE' => 'This transaction will subtract "+(parseFloat(amount)+parseFloat(fee))+" NK from your balance.',
		'THIS_SUBSTRACTBALANCE2' => 'This transaction will subtract "+amount+" NK from your balance.',
		'TRANSACTION_QUEUE' => 'Transaction has been added to the queue.',
		'NK_TO' => 'NK have been transferred to',
...
You can change the registration address to one of your addresses or any other address later.',
		...
		'MAINTENANCE_MAINTENANCE' => 'The Neko Blockchain Explorer is currently down for maintenance!',
