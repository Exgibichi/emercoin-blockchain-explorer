...
function lang($phrase){
    static $lang = array(
		...
		'TX_VOLUME_NK' => 'TX Volumen [NK]',
		'TX_FEE_NK' => 'TX Gebühr [NK]',
		...
		'COINS_AVAILABLE' => 'Nekos im Umlauf',
		...
		'VALUE_NK' => 'Wert [NK]',
		'WELCOME_EXPLORER' => 'Willkommen zum Neko Blockchain Explorer',
		...
		'BALANCE_NK' => 'Guthaben [NK]',
		'HOLDINGS_NK' => 'Besitz [NK]',
		...
		'THIS_BALANCE2' => 'NK from your balance.',
		'TRANSACTION_NK' => 'Transaktionsgebühr:',
		'USERNAME_USERNAME' => 'Benutzername',
		'VALID_EXTERNAL' => 'gültig (extern)',
		'VALID_INTERNAL' => 'gültig (intern)',
		'VOLUME_VOLUME' => 'Volumen',
		'NKSSL_VERYHIGH' => 'NKSSL mit deinem Passwort [Sehr hohe Sicherheit]',
		'NKSSL_HIGH' => 'NKSSL ohne Passwort [Hohe Sicherheit]',
		'NKSSL_LOW' => 'NKSSL ODER Passwort [Geringe Sicherheit]',
		'NKSSL_DEACTIVATE' => 'Deaktiviere NKSSL',
		'YOUR_CERTIFICATE' => 'Dein NKSSL Zertifikat',
		'YOU_LOGIN' => 'Du kannst NKSSL nutzen um deinen Login abzusichern.',
		'WHAT_NKSSL' => 'Was ist NKSSL?',
		...
		'STOCK_BTC' => 'Börse - NK/BTC',
		'STOCK_USD' => 'Börse - NK/USD',
		...
		'THIS_SUBSTRACTBALANCE' => 'Diese Transaktion wird "+(parseFloat(amount)+parseFloat(fee))+" NK von deinem Guthaben abbuchen.',
		'THIS_SUBSTRACTBALANCE2' => 'Diese Transaktion wird "+amount+" NK von deinem Guthaben abbuchen.',
		'TRANSACTION_QUEUE' => 'Die Transaktion wurde der Warteschlange hinzugefügt.',
		'NK_TO' => 'NK wurden übertragen an',
...
Du kannst später dem Namen eine deiner Adresse zuweisen.',
		...
		'NKSSL_SET' => 'NKSSL wurde gesetzt"',
		'MAINTENANCE_MAINTENANCE' => 'Der Neko Blockchain Explorer ist aktuell im Maintenancemodus!',
